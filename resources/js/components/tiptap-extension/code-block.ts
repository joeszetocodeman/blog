...
export const CodeBlock = Node.create<CodeBlockOptions>({
    ...
    parseHTML() {
        console.log('Parsing HTML for codeBlock');
        return [
            {
                tag: 'pre',
    ...
    renderMarkdown: (node, h) => {
        console.log('Rendering Markdown for codeBlock', node);
        let output = '';
            ...
            'Shift-Tab': ({ editor }) => {
                ...
                return editor.commands.command(({ tr }) => {
                    ...
                    tr.replaceWith(
                        from,
                        to,
                        state.schema.text(reverseIndentText),
                    );
                    return true;
                });
            },
    ...
    addProseMirrorPlugins() {
        console.log('Adding ProseMirror plugins for codeBlock');
        return [
                ...
                props: {
                    handlePaste: (view, event) => {
                        ...
                        tr.replaceSelectionWith(
                            this.type.create({ language }, textNode),
                        );
